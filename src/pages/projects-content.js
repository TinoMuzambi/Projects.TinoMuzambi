const projects = [
	{
		...
		title: "Table Time",
		content: [
			`A simple React Table Tennis scoring app that stores all matches recorded to a database.`,
			...
			`The frontend hooks up to an Express server backend. The backend uses a REST API to get matches from the database as well as to post them to save them to the database.`,
